            ...
            <div className="col">
                <div className="card h-100 shadow-sm"> <img src={image} className="card-img-top" alt="..." />
                    <div className="card-body">
                        <div className="clearfix mb-3"> <span className="float-start badge rounded-pill bg-primary">{name}</span> <span className="float-end text-danger fw-bold price-hp">{price} Tk</span> </div>
